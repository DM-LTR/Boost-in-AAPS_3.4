...
@Singleton
open class OpenAPSBoostV3Plugin @Inject constructor(
    ...
    private val determineBasalBoost: DetermineBasalBoostV3,
    ...
    PluginDescription()
        ...
        .pluginName(R.string.openaps_boost_v3)
        ...
        .description(R.string.description_boost_v3),
    aapsLogger, rh
    ...
    data class BoostIsfResult(
        ...
        val tdd: Double,
        val isfDebug: String = "",
        // Deviation sensitivity fields (for RT upload + UI display)
        val deviationSensRatio: Double? = null,   // applied ratio (null if adjustSens off)
        val deviationSensSource: String = "none",  // "deviation", "tdd_fallback", or "none"
        val deviationSensClean: Int = 0,           // clean entries in 8H window
        val deviationSensTotal: Int = 0,           // total entries in 8H window
    )
    ...
    private fun calculateBoostIsf(
        ...
        if (useTdd) {
            ...
            if (tdd7D != null && tdd1D != null && tddLast24H != null && tddLast4H != null && tddLast8to4H != null && tdd7D > 0) {
                ...
                if (tdd > 0 && logTerm > 0) {
                    ...
                    aapsLogger.warn(LTag.APS, "BoostV3 TDD ISF: invalid tdd=$tdd or logTerm=$logTerm, falling back to profile ISF")
                }
            } else {
        ...
        if (isTempTarget && ((highTtRaisesSens && targetBg > bgNormalTarget) || (lowTtLowersSens && targetBg < bgNormalTarget))) {
            ...
            if (c * (c + targetBg - bgNormalTarget) > 0.0) {
                ...
                aapsLogger.debug(LTag.APS, "BoostV3 ISF adjusted by ${1.0 / ratio} due to TT of ${targetBg.toInt()}")
            }
        }
        ...
        aapsLogger.debug(LTag.APS, "BoostV3 ISF: $debug")
